...
REPOOUTPUT=$(curl -k -u $TL_USER:$TL_PASS \
  ...
  https://console-master-guynoy.guynoy.demo.twistlock.com/api/v1/coderepos?id=se-cloud-emea-demo%2Fgnoy-evil.petclinic&limit=15&offset=0&project=Central+Console&reverse=true&sort=vulnerabilityRiskScore)
